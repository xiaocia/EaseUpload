    ...
    return new Promise(function (resolve) {
        ...
        if ('length' in chunks) {
            ...
            if (chunks.size < 1024 * 1024 * 10) {
                ...
                // 不分片且文件大
                var file = chunks.file;
                _chunks.push(__assign(__assign({}, chunks), { file: file.slice(0, 1024 * 1024 * 2) }));
                _chunks.push(__assign(__assign({}, chunks), { file: file.slice(~~(file.size / 2), ~~(file.size / 2) + 1024 * 1024 * 2) }));
                _chunks.push(__assign(__assign({}, chunks), { file: file.slice(file.size - 1024 * 1024 * 2, file.size) }));
            }
        }
