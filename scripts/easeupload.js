...
var R = /* @__PURE__ */ function() {
  var s = function(f, u) {
    return s = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(h, a) {
      ...
      for (var p in a)
        Object.prototype.hasOwnProperty.call(a, p) && (h[p] = a[p]);
    }, s(f, u);
  };
  return function(f, u) {
    ...
    function() {
      ...
      return s.prototype.result = function(f, u, h) {
        if (!(f && !this.NOT) && !(!f && this.NOT)) {
          ...
          if (this.SLIENT && console.warn(new T(a)), !this.SLIENT)
            throw new T(a);
        }
  ...
  var f = q(), u = Object.getPrototypeOf(new f()), h = Object.assign(s || {}, K), a = Object.keys(h).reduce(function(p, c) {
    var l = "is".concat(L(c));
    return p[l] = function(d, _) {
      var g = this;
      s[c](g.VALUE, d) ? g.result(!0, _, l) : g.result(!1, _, l);
    }, p;
  }, {});
  return Object.assign(u, a), function(p) {
    return new f().value(p);
  };
};
const w = G({});
var W = (
  ...
  /* @__PURE__ */ function() {
    function s() {
      ...
      this.eventBus = {}, this.on = function(u, h) {
        ...
        var a = f.eventBus;
        Array.isArray(a[u]) && a[u].forEach(function(p) {
          return p(h);
        });
      }, this.off = function(u, h) {
        w(u).isTypeOf(String, "eventName must be a string"), w(h).isTypeOf(Function, "callback must be a funtion");
        var a = f.eventBus;
        Array.isArray(a[u]) && (a[u] = a[u].filter(function(p) {
          return h !== p;
        }));
...
(function(s, f) {
  (function(u) {
    ...
    g(l("hello")), typeof ArrayBuffer < "u" && !ArrayBuffer.prototype.slice && function() {
      function o(i, e) {
        return i = i | 0 || 0, i < 0 ? Math.max(i + e, 0) : Math.min(i, e);
      }
      ArrayBuffer.prototype.slice = function(i, e) {
        var t = this.byteLength, n = o(i, t), r = t, b, A, v, j;
        return e !== u && (r = o(e, t)), n > r ? new ArrayBuffer(0) : (b = r - n, A = new ArrayBuffer(b), v = new Uint8Array(A), j = new Uint8Array(this, n, b), v.set(j), A);
      };
    }();
    function m(o) {
    ...
    return y.prototype.append = function(o) {
      ...
      for (e = 64; e <= i; e += 64)
        a(this._hash, p(this._buff.substring(e - 64, e)));
      ...
      return o.buff = F(o.buff, !0), y.prototype.setState.call(this, o);
...
const X = /* @__PURE__ */ J(Q), Y = (s) => new Promise((f) => {
  ...
  if (s.length !== 1)
    for (const c in s)
      if (c === "0" || c === s.length - 1 + "")
        ...
        const l = s[c].file;
        u.push({ ...s[c], file: l.slice(0, 2) }), u.push({ ...s[c], file: l.slice(~~(l.size / 2), ~~(l.size / 2) + 2) }), u.push({ ...s[c], file: l.slice(l.size - 2, l.size) });
      }
  else if (s[0].allSize < 1024 * 1024 * 10)
    u.push(s[0]);
  else {
    const c = s[0].file;
    u.push({ ...s[0], file: c.slice(0, 1024 * 1024 * 2) }), u.push({ ...s[0], file: c.slice(~~(c.size / 2), ~~(c.size / 2) + 1024 * 1024 * 2) }), u.push({ ...s[0], file: c.slice(c.size - 1024 * 1024 * 2, c.size) });
  }
  const h = new X(), a = (/* @__PURE__ */ new Date()).valueOf(), p = (c) => {
    if (c >= u.length) {
      const _ = h.end(!1);
      console.log("计算hash用时:", ((/* @__PURE__ */ new Date()).valueOf() - a) / 1e3), f(_);
      return;
    }
    const l = u[c].file, d = new FileReader();
    d.onload = (_) => {
  ...
  const d = () => {
    ...
    l++, await m(), l--, p++, f.emit("progress", (p / a * 100).toFixed(2)), _();
  };
  for (; l < c; )
    d();
}, k = (s) => {
...
const et = (s) => {
  ...
  return u.onchange = () => {
    ...
    new Promise((d) => {
      if (f.emit("change", null), typeof s.chunkSize == "number") {
        if (l.size < s.chunkSize * 1024 * 1024)
      ...
      Y(h).then((_) => {
        h = h.map((g, m) => ({ ...g, id: `${_}-${m}` })), f.emit("changeFinish", {
          file: l,
          fileSize: tt(l.size),
          resolve: d
        });
  ...
  }, { show: a, addListener: (l, d) => {
    f.on(l, d);
  }, start: () => {
    console.log("开始传输！"), S.length !== 0 && Z(S, f, s.concurrent);
  } };
};
export {
  et as default
